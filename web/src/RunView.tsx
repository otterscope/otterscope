...
// RunView is the presentational run detail — header stats, assertion chips,
// step timeline, and click-to-inspect panel. Shared by the authenticated
// run page and the public shared-link page.
export default function RunView({ detail }: { detail: Detail }) {
          ...
          {sel.llm && (
            <>
              <p className="hint">
                ...
                {sel.llm.costUsd !== undefined && ` · ${fmtCost(sel.llm.costUsd)}`}
              </p>
